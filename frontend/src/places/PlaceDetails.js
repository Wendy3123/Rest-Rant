...
function PlaceDetails() {
  ...
  if (place.comments.length) {
    ...
    rating = <h3 className="placedetailinfo2 ">{stars} stars</h3>;
    ...
    <main>
      <div className="row">
        <div className="col-sm-6">
          <img className="placesindexpics" src={place.pic} alt={place.name} />
          <h3 className="placedetaildes">
            Located in {place.city}, {place.state}
          </h3>
        </div>
        <div className="col-sm-6">
          <h1 className="placedetailinfo">{place.name}</h1>
          <h2 className="placedetailinfo2">Rating</h2>
          {rating}
          <br />
          <h2 className="placedetailinfo2">Description</h2>
          <h3 className="placedetaildes">
            {place.name} has been serving {place.city}, {place.state} since{" "}
            {place.founded}.
          </h3>
          <h4 className="placedetaildes">Serving {place.cuisines}.</h4>
          <br />
      ...
      <hr />
      <h2 className="placedetailinfo2">Comments</h2>
      <div className="row">{comments}</div>
      <hr />
      <h2 className="placedetailinfo2">Got Your Own Rant or Rave?</h2>
